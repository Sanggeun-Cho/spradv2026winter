package com.thc.spradv2026winter.security;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.exceptions.JWTVerificationException;
import com.thc.spradv2026winter.domain.RefreshToken;
import com.thc.spradv2026winter.exception.InvalidTokenException;
...
public class AuthServiceImpl implements AuthService {
     ...
     */
    @Override
    public String cretaeAccessToken(Long userId) {
        return JWT.create()
    ...
    public String issueAccessToken(String refreshToken) throws JWTVerificationException {
        ...
        String accessToken = cretaeAccessToken(userId);
